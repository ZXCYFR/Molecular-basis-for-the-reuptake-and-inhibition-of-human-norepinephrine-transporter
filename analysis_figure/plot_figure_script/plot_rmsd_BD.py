...
def plot_pdf(ligand,system):
    ...
    plt.plot(x1,y1_smooth,color='steelblue',linewidth=2.5,label='Repeat1') # ,linestyle='--',alpha=1
    plt.plot(x2,y2_smooth,color='darkorange',linewidth=2.5,label='Repeat2') # ,linestyle='--',alpha=1
    plt.plot(x3,y3_smooth,color='forestgreen',linewidth=2.5,label='Repeat3') # ,linestyle='--',alpha=1
    plt.title('RMSD for Protein Backbone',fontfamily='Arial',fontsize=28)
